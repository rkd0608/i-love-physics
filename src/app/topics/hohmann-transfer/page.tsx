  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Two race tracks loop the same pond, an inner lane and an outer lane,
          and you want to move out without wasting pushes. Push once and your
          round track stretches into an oval that just kisses the outer lane;
          coast halfway around touching nothing; push once more to stay there.
          Any other path meets the lanes at wrong angles and costs extra fuel.{" "}
          <strong className="text-fg">
            One push to leave, one to arrive, nothing in between.
          </strong>
        </p>
      </Section>
