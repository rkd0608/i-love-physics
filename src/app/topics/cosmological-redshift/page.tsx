  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Draw a wiggly line on a rubber band and stretch it: the wiggles pull
          wider apart. Light flying across the universe rides that same
          rubbery space. While a beam travels from a far galaxy to your eye,
          the space under it grows, so its wiggles stretch wider and the light
          looks redder. The galaxy isn’t running away — the rubber between you
          is being stretched, and farther galaxies give their light longer
          rides.{" "}
          <strong className="text-fg">
            Space stretches the light’s wiggles while it travels.
          </strong>
        </p>
      </Section>
              ...
              <ProgressToggle slug="cosmological-redshift" />
              <TopicMetrics slug="cosmological-redshift" />
