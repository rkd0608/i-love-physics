  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Ride a wagon from pavement onto mud at a slant. The wheel that hits
          mud first slows down and drags, so the wagon turns. Light does the
          same trick: it walks slower through water or glass than through air,
          so a slanted beam bends when it crosses over. That is refraction —
          light changing direction because its speed changes. Stick a straw in
          a glass of water and it looks broken at the surface.{" "}
          <strong className="text-fg">
            Light bends because it always takes the fastest path.
          </strong>
        </p>
      </Section>
