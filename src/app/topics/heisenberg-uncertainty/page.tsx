  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Watch a marble roll down a ramp and you can say where it is and how
          fast it goes — no problem. Tiny dots are different: knowing where one
          is blurs how fast it goes. Squeeze the dot into a needle-sharp point
          and its speed smears toward every value at once; let it wander wide
          and its speed snaps into focus. No trick ever catches both crisp at
          the same time.{" "}
          <strong className="text-fg">
            Pin down where it is, and how fast goes blurry.
          </strong>
        </p>
      </Section>
              ...
              <TopicMetrics slug="heisenberg-uncertainty" />
