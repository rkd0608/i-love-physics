  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Here’s a rule a five-year-old can do: multiply your number, over and
          over. Each round the number grows, runs out of room, and gets
          squeezed back down. Keep the dial low and the number settles onto one
          cozy value. Nudge it higher and the number bounces between two
          values, then four, then eight. Push it past a secret spot and it goes
          truly wild — hopping to fresh values forever, never repeating, never
          settling.{" "}
          <strong className="text-fg">Simple multiplying, repeated enough, suddenly goes wild forever.</strong>
        </p>
      </Section>
