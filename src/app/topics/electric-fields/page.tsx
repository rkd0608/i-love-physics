  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Rub a balloon on your hair and it sticks to the wall. Rubbing moves
          invisible stuff called charge around. Charge pushes and pulls other
          charge across empty space, no touching needed. Imagine pointing one
          arrow at every spot, showing which way a tiny test charge would feel
          pushed. Together those arrows paint an invisible map called a field.
          More charges just mean more arrows added together. You never see the
          map — you only feel it when you walk in.{" "}
          <strong className="text-fg">A field is a map of pushes waiting in space.</strong>
        </p>
      </Section>
              ...
              <TopicMetrics slug="electric-fields" />
