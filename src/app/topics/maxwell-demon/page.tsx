  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Picture a box of bouncy balls split by a wall with a tiny door. A
          little doorkeeper peeks at every ball that comes near. Fast balls he
          waves through one way; slow balls the other way. Soon one half holds
          zooming, hot balls and the other half drifts slow and cold — the box
          is much less mixed-up than before. Free tidiness! Except the
          doorkeeper must jot down every ball he sees, and later he must wipe
          his notebook clean, which heats things up more than his sorting
          cooled them.{" "}
          <strong className="text-fg">
            Keeping the notebook tidy costs more mess than it saves.
          </strong>
        </p>
      </Section>
              ...
              <TopicMetrics slug="maxwell-demon" />
