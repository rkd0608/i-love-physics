  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Shake iron filings near a fridge magnet and every speck spins to
          point the same way. Each filing is a tiny compass. A magnet has two
          ends, and matching ends shove apart while opposite ends hug. Each
          little compass twists until its north tip sniffs along the local
          pull. Fill a whole grid with compasses and they draw the magnet’s
          invisible map all by themselves — nobody plots a single arrow.{" "}
          <strong className="text-fg">Every filing is a tiny compass drawing one big map.</strong>
        </p>
      </Section>
