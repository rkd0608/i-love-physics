  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Stand in a big forest and every direction you look ends on a tree
          trunk. An endless, ageless universe should do the same with stars:
          glance anywhere and your eye should land on a star, until night
          glows like daytime. Ring upon ring of stars ties perfectly — each
          ring is dimmer per star but stuffed with more of them. The sky stays
          dark anyway, because light from the farthest rings hasn’t had time
          to reach you yet.{" "}
          <strong className="text-fg">
            The dark night sky proves the universe had a birthday.
          </strong>
        </p>
      </Section>
