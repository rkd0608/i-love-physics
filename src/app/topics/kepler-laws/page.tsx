  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-16 px-6 py-14 sm:py-20">
      ...
      <Section index="02" title="Explain it like I’m five">
        <p className="leading-relaxed text-fg/90">
          Tie a ball to a string, swing it around your head, then shorten the
          string: the ball speeds up. Planets ride invisible strings to the
          Sun along squashed-circle tracks with the Sun off-center. Dip close
          and they sprint; swing far and they coast. The line from planet to
          Sun sweeps same-size slices every second — skinny-and-fast near,
          fat-and-slow far — and close tracks still finish laps sooner than
          wide ones.{" "}
          <strong className="text-fg">
            Closer to the Sun, faster the planet runs.
          </strong>
        </p>
      </Section>
